...
let
  ...
  gids = mapAttrsToList (n: toGID) (filterAttrs (n: v: isCreated cfg.knownGroups n) cfg.groups);
  uids = mapAttrsToList (n: toUID) (filterAttrs (n: v: isCreated cfg.knownUsers n) cfg.users);
